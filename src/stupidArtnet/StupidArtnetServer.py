...
class StupidArtnetServer():
    ...
    def __init_socket(self):
        ...
        self.socket_server.bind(('192.168.1.91', self.UDP_PORT))  # Listen on any valid IP
    ...
    def __str__(self):
        ...
        state = "===================================\n"
        state += "MergeUniverse {Version} Started!\n"
        return state

    def register_listener(self, universe=15, sub=0, net=0,
                          is_simplified=True, callback_function=None):
        """Adds a listener to an Art-Net Universe.

        Args:
        universe - Universe to listens
